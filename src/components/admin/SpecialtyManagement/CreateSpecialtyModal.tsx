...
import { X, Layers, Building } from 'lucide-react';

interface CreateSpecialtyModalProps {
  onClose: () => void;
  onSubmit: (specialtyData: { name: string; code: string; department: string; description: string }) => void;
  departments: string[];
}
      ...
      <div className="bg-white rounded-lg max-w-xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900">Create New Specialty</h2>
              <p className="text-sm text-gray-600">Add a new specialty to a department</p>
            </div>
          </div>
          <button
            onClick={onClose}
